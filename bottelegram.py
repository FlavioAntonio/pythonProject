...
def ativar_windows(message):
    ...
    if executar == "1":
        execute_bate(r"C:\Users\AN20165014\Documents\script\windows.bat > novachave.txt")
        # alinha abaixo envia o texto do arquivo
        with open(r"C:\Users\AN20165014\PycharmProjects\pythonProject\novachave.txt", 'rb') as arquivo:
